...
class ModelTraining:
    ...
    def __init__(self, train_path, test_path, model_output_path):
        ...
        self.params_dict = LIGHTGM_PARAMS
    ...
    def train_lgbm(self, X_train, y_train):
        try:
            logger.info("Initializating Light GBM model")
            lgbm_model = lgb.LGBMClassifier(random_state=self.random_search_params['random_state'])
            
            logger.info("Starting hyper parameter tuninig")
            ...
            logger.info("Run started from hyper paramater tuning")
            random_search.fit(X_train, y_train)
            logger.info("Run completed from hyper paramater tuning")
    ...
    def run(self):
        try:
            ...
            experiment_name = "hotel_prediction_experiment"
            mlflow.set_experiment(experiment_name)

            with mlflow.start_run():
                logger.info("Starting our Model training pipeline")
                logger.info("Starting our MLFLow run")
