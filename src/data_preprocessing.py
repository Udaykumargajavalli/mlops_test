...
class DataPreprocessing:
    ...
    def preprorcess_data(self, df):
        try:
            ...
            logger.info("Applying label econding")
    ...
    def balance_data(self, df):
        try:
            logger.info("Balacing is started")
            ...
            logger.error(f"Error while Balancing the data step {e}")
            raise CustomException("Error while Balanced data", e)
    ...
    def select_features(self, df):
        try:
            ...
            logger.info("Feature selection step completed")
    ...
    def process(self):
        try:
            logger.info("Loading data from rawu directiory")
            ...
            trian_df = self.select_features(train_df)
            ...
            logger.error(f"Error while data preporcessing pipeline {e}")
            raise CustomException("Error while data preporcessing pipeline", e)
